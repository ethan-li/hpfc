...
class TestFolderCompare(unittest.TestCase):
    ...
    def test_basic_comparison(self):
        ...
        # Check results
        self.assertEqual(len(results["identical_files"]), 2)  # same_file.txt and subdir/sub_same.txt
        self.assertEqual(len(results["different_files"]), 2)  # different_file.txt and subdir/sub_diff.txt
    ...
    def test_ignore_patterns(self):
        ...
        comparer = FolderCompare(
            self.test_dir1, 
            self.test_dir2,
            ignore_patterns=["only_in_dir1", "only_in_dir2"]
        )
        results = comparer.compare()
