...
Supports cross-platform operation (Windows, Linux, macOS) and can efficiently handle
large volumes of files and large file sizes.
"""
...
class ProgressBar:
    ...
    def _print_progress(self) -> None:
        ...
        progress_line = f'\r{self.prefix} |{bar}| {percent}% {self.iteration}/{self.total} {eta_str} {self.suffix}'
...
class FolderCompare:
    ...
    def __init__(
        ...
        Args:
            ...
            max_workers: Maximum number of worker processes for parallel processing, None for CPU count
    ...
    def compare(self) -> Dict:
        ...
        self.total_files_processed = len(common_files) + len(self.missing_files) + len(self.extra_files)
        ...
        if common_files:  # Only start parallel processing if there are common files
            ...
            if self.show_progress:
                progress = ProgressBar(len(common_files), prefix='Progress:', suffix='Complete', length=50)
            ...
            with ProcessPoolExecutor(max_workers=self.max_workers) as executor:
                ...
                future_to_file = {
                    executor.submit(
                        self.compare_files, 
                        rel_path, 
                        files_dict1[rel_path], 
                        files_dict2[rel_path]
                    ): rel_path 
    ...
    def generate_text_report(self, results: Dict = None) -> str:
        ...
        speed = results["total_size_processed"] / results["time_elapsed"] if results["time_elapsed"] > 0 else 0
            ...
            <div class="container">
                ...
                <div class="stats">
                    ...
                    <div class="stat-box">
                        ...
                        <div class="stat-value {% if identical_files_count == total_files %}success{% endif %}">
                            {{ identical_files_count }}
                        </div>
                    </div>
                    <div class="stat-box">
                        <div class="stat-title">Different Files</div>
                        <div class="stat-value {% if different_files_count > 0 %}warning{% endif %}">
